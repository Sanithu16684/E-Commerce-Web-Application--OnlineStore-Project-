        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    <div class="col-12 col-lg-3 mt-3 mb-3">
                        <label class="form-label fs-5 text-white">Search by Invoice ID : </label>
                        <input type="text" class="form-control border border-white fs-5" id="searchtxt" onkeyup="searchInvoice();"/>
                    </div>
                    <div class="col-12 col-lg-2 mt-3 mb-3"></div>
                    <div class="col-12 col-lg-3 mt-3 mb-3">
                        <label class="form-label fs-5 text-white">From Date : </label>
                        <input type="date" class="form-control border border-white fs-5" id="from"/>
                    </div>
                    <div class="col-12 col-lg-3 mt-3 mb-3">
                        <label class="form-label fs-5  text-white">To Date : </label>
                        <input type="date" class="form-control border border-white fs-5" id="to"/>
                    </div>
                    <div class="col-12 col-lg-1 mt-3 mb-3 d-grid">
                        <button class="btn btn-primary text-white fs-5 fw-bold" onclick="findsellings();">Find</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-2 bg-body-tertiary text-center">
                        <label for="form-label fs-5 fw-bold text-dark">Status</label>
                    </div>
