                            ...
                            ?>
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-1 text-center text-lg-start" style="background-color: #3d0a91;">
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="card-body">
                                                                ...
                                                                ?>
                                                                    <span class="badge rounded-pill text-bg-danger" id="state">Waiting to accept</span>
                                                                <?php
                                                                } else if ($invoice_data["status"] == "1") {
                                                                ?>
                                                                    <span class="badge rounded-pill text-bg-warning" id="state">Packing</span>
                                                                <?php

                                                                } else if ($invoice_data["status"] == "2") {
                                                                ?>
                                                                    <span class="badge rounded-pill text-bg-info" id="state">Dispatch</span>
                                                                <?php

                                                                } else if ($invoice_data["status"] == "3") {
                                                                ?>
                                                                    <span class="badge rounded-pill text-bg-primary" id="state">Shipping</span>
                                                                <?php

                                                                } else if ($invoice_data["status"] == "4") {
                                                                ?>
                                                                    <span class="badge rounded-pill text-bg-success" id="state">Delivered</span>
                                                                <?php
                                        ...
                                        <div class="col-12 col-lg-2  text-center text-lg-end" style="background-color: #3d0a91;">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <div class="row">
                                                ...
                                                <div class="col-6 d-grid">
                                                    <button class="btn btn-danger rounded mt-5 fs-5" onclick="deletePurchasingItem(<?php echo $invoice_data['invoice_id']; ?>);">
                            ...
                            <div class="col-12 mb-3">
                                <div class="row">
                                    <div class="offset-lg-10 col-12 col-lg-2 d-grid">
                                        <button class="btn btn-danger rounded mt-5 fs-5" onclick="deleteAllPurchasingItem();">
