...
function buyNow(id) {
  ...
  request.open("GET", "cartBuyNowProcess.php?id=" + id + "&qty=" + qty, true);
  request.send();
}
...
function loadMainImg(id) {
   ...
   document.getElementById("mainImg").src=id;
...
function addToCartWachlist(id) {
  ...
  request.open("GET", "addToCartWachlistProcess.php?id=" + id, true);
  request.send();
}
...
function deletePurchasingItem(id) {
  ...
  request.open("GET", "removePurchasingItemProcess.php?id=" + id, true);
  request.send();
}
...
function dltCat(id){
  ...
  request.open("GET", "removeCategoryProcess.php?id=" + id, true);
  request.send();
}
...
request.open("GET", "orderStateChangeProcess.php?id="+id , true);
request.send();

}

function deleteAllPurchasingItem(id){
  ...
  request.open("GET", "removeAllPurchasingItemProcess.php?id=" + id, true);
  request.send();

}
function selectedProductView(id) {

 var offcanvas = document.getElementById("offcanvasExamplec");
  ...
  request.onreadystatechange = function () {
    if (request.status == 200 && request.readyState == 4) {
      var response = request.responseText;
      document.getElementById("offcanvasExample").innerHTML=response;
  ...
  request.open("GET", "selectedProductViewProcess.php?id=" + id, true);
  request.send();
}
