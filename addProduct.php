    ...
    <div class="container-fluid">
        <div class="row gy-3">
            ...
            ?>
                ...
                <div class="offset-lg-3 col-12 col-lg-6 border border-1 p-lg-5">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6 border-success">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label class="form-label fw-bold" style="font-size: 20px;">Warrenty</label>
                                                </div>
                                                <div class="offset-0 offset-lg-2 col-12 col-lg-8">
                                                    <div class="input-group mb-2 mt-2">
                                                        <input type="text" class="form-control" id="warrenty" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.png" class="img-fluid" style="width: 250px;" id="i0" />
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.png" class="img-fluid" style="width: 250px;" id="i1" />
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.png" class="img-fluid" style="width: 250px;" id="i2" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="offset-lg-4 col-12 col-lg-4 d-grid mt-3 mt-lg-5 mb-3">
