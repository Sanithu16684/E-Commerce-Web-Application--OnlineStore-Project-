...
<head>
    ...
    <title>Advanced Search | Online Store</title>
        ...
        <div class="row">
            ...
            <div class="col-12 bg-body mb-2">
                <div class="row">
                    <div class="offset-lg-4 col-12 col-lg-4">
                        <div class="row">
                            <div class="col-2">
                                <div class="mt-2 mb-2 logo" style="height: 80px;" onclick="window.location='home.php';"></div>
                            </div>
                            <div class="col-10 text-center">
                                <P class="fs-1 text-white-50 fw-bold mt-3 pt-2">Advanced Search</P>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-2 mb-2">
                                        <select id="s" class="form-select border border-top-0 border-start-0 border-end-0 border-2 border-white">
                    ...
                    <div class=" col-12 col-md-8 col-lg-9 bg-body rounded mb-3">
                        <div class="row">
                            <!-- <h1>hello World</h1> -->
                            <div class="offset-lg-1 col-12 col-lg-10 text-center">
                                <div class="row" id="view_area">
                                    <div class="offset-5 col-2 mt-5">
                                        <span class="fw-bold text-white-50"><i class="bi bi-search h1" style="font-size: 100px;"></i></span>
                                    </div>
                                    <div class="offset-3 col-6 mt-3 mb-5">
                                        <span class="h1 text-white-50 fw-bold">No Items Searched Yet...</span>
                                    </div>
                                </div>
                            </div>
                        </div>
