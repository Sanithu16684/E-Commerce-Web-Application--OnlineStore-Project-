            ...
            ?>
                <div class="col-12 ">
                    <div class="row">
                        ...
                        <div class="col-12 offset-md-3 col-md-6 bg-body rounded mt-4 mb-4 border border-1">
                            <div class="row g-2">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" id="ptext" class="form-control bg-dark" value="<?php echo $user_details["password"]; ?>" readonly />
                                                    <span class="input-group-text bg-primary" id="basic-addon2" onclick="showpass();">
                                                        <i id="show" class="bi bi-eye-fill text-white" style="display:none"></i>
                                                        <i id="hide" class="bi bi-eye-slash-fill text-white"></i>
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control bg-dark" readonly value="<?php echo $user_details["email"]; ?>" />
                                            </div>

                                            <div class="col-12">
                                                <label class="form-label">Registered Date</label>
                                                <input type="text" class="form-control bg-dark" readonly value="<?php echo $user_details["joined_date"]; ?>" />
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control bg-dark" value="<?php echo $user_details["gender_name"]; ?>" readonly />
                                            </div>

                                            <div class="wrap mt-5">
                                                <button class="button" onclick="updateProfile();">Update</button>
                                            </div>
