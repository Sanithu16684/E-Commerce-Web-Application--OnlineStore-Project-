                        ...
                        <div class="card col-6 col-lg-2 mt-3 mb-3" style="width: 18rem;">
                            ...
                            <div class="card-body ms-0 m-0 text-center">
                                ...
                                if (isset($_SESSION["u"])) {
                                    ...
                                    ?>
                                        <button class="px-5 btn btn-outline-info border border-primary" onclick='addToWatchlist(<?php echo $selected_data["id"]; ?>);'>
                                            <i class="bi bi-heart-fill text-white fs-5" id="heart<?php echo $selected_data["id"]; ?>"></i>
                                        </button>
                                <?php
                                    }
                                }
